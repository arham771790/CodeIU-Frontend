          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="card bg-base-200  md:p-6 shadow-md border border-white/10 rounded-md p-6">
              <div className="flex items-center justify-between mb-4 ">
                ...
                <button
                  type="button"
                  className=" flex items-center justity-center btn btn-primary btn-sm border border-white hover:bg-[#4085F1] hover:text-white rounded-md px-4 py-2 gap-2 cursor-pointer"
                  onClick={() => appendTag("")}
                >
                  ...
                  <div key={field.id} className="card bg-base-100 shadow-md">
                    <div className="card-body p-4 md:p-6">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <button
                          type="button"
                          className="flex items-center justify-center btn btn-ghost btn-sm text-error border border-white hover:bg-red-900 hover:text-white rounded-md px-4 py-2 gap-2 cursor-pointer"
