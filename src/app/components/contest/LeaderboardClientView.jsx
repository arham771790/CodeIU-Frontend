...
export default function LeaderboardClientView({ contestId, initialData }) {
  ...
  // 1. Hydrate Store immediately
  useEffect(() => {
    if (initialData) {
      setInitialLeaderboard(initialData);
    }
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-gray-900 hover:bg-gray-800 border border-gray-800 text-sm transition-colors"
                title="Refresh"
              >
                <RefreshCcw
