...
import { User, Eye, CheckSquare, MessageSquare, Star, Github, Linkedin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="bg-base-200/50 backdrop-blur-md border border-base-content/10 rounded-[2.5rem] p-8 text-center relative overflow-hidden group">
        ...
        <Link href="/profile/edit" className="w-full btn btn-primary btn-sm rounded-xl font-black uppercase tracking-widest text-[10px]">
          Edit Protocol
        </Link>
      </div>
