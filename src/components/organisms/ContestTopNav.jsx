  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message="Are you sure you want to end your session? Your current progress will be submitted, and you won't be able to resume."
        confirmText="Yes, Finish Contest"
        type="warning"
      />
    </>
  );
