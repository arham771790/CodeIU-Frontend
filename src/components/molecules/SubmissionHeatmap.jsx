...
const SubmissionHeatmap = ({ data = [] }) => {
  ...
  return (
    <div className="bg-base-200/50 backdrop-blur-md border border-base-content/10 rounded-[2.5rem] p-4 sm:p-8">
      {/* 1. Matrix Header */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6 sm:mb-8">
        ...
        <div className="flex items-center gap-3 sm:gap-6 text-[10px] font-black uppercase tracking-widest opacity-40 overflow-x-auto">
      ...
      <div className="relative overflow-x-auto pb-4 custom-scrollbar">
        <div className="grid grid-cols-53 grid-rows-7 grid-flow-col gap-1.5 min-w-[600px]">
          {data.map((level, i) => (
            <div
              key={i}
        ...
        <div className="flex justify-between text-[9px] font-black text-base-content opacity-20 mt-4 px-1 font-mono uppercase tracking-[0.2em] min-w-[600px]">
